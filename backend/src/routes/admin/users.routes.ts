...
adminUsersRouter.get('/search-users', (req, res) => adminUsersController.searchUsers(req, res))
...
adminUsersRouter.get('/search-verification-users', (req, res) => adminUsersController.searchVerificationUsers(req, res));
